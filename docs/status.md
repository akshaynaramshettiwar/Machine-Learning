...
|-------|---------|-------|---------|--------|-------|-----|
| Cycle 1 | CYCLE-1 | Admin Dashboard Filters & Reporting (pattern adoption + DB indexes + filter API + filter UI + PDF/CSV exports) | 11/11 | Done | 2026-05-15 | — |
